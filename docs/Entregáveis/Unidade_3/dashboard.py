...
# =====================================================================
# 1. CONFIGURAÇÃO DA PÁGINA (FORÇANDO MODO CLARO)
# =====================================================================
...
<style>
    ...
    /* FORÇA as cores dos textos para ignorar o SO, mas PRESERVA os ícones nativos */
    ...
    .grafico-desc {{ background-color: {bg_desc}; padding: 12px 16px; border-radius: 8px; border-left: 4px solid #a7197f; margin-top: 8px; margin-bottom: 20px; font-size: 0.88rem; color: {text_main} !important; line-height: 1.6; border: 1px solid {border_color}; }}
    .grafico-desc strong {{ color: #a7197f !important; font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.05em; }}
    
    /* Correção das Caixas de KPI para se adaptarem ao modo escuro ou claro */
...
# =====================================================================
st.markdown(f"<h1 style='color: {text_main};'>📊 Painel Analítico: Ludopatia & BETs</h1><p style='color: {text_muted}; font-size: 1.1rem;'>Análise técnica sobre o impacto das apostas online na estrutura socioeconômica.</p>", unsafe_allow_html=True)
