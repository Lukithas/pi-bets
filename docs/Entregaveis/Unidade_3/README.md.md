...
- **Perfil Epidemiológico** — Microdados de pacientes (DataSUS, CID-10 F63.0), com fallback simulado.
...
Na barra superior da aplicação, estão disponíveis:

- **Fonte − / Fonte +** — ajusta o tamanho do texto em todo o painel.
- **Contraste** — ativa um modo de alto contraste para melhor legibilidade.
